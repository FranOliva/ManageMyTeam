...
class DateUtil {
    ...
    companion object {
        ...
        fun format(timestamp: Long, format: String = DEFAULT_DATE_TIME_FORMAT): String {
            return format(Date().apply { time = timestamp }, format)
        }

        fun format(calendar: Calendar, format: String = DEFAULT_DATE_TIME_FORMAT): String {
            return format(calendar.timeInMillis, format)
        }

        fun format(year: Int, month: Int, day: Int, format: String = DEFAULT_DATE_TIME_FORMAT): String {
